...
export const ProjectIcon = React.forwardRef<SVGSVGElement, React.ComponentPropsWithoutRef<'svg'>>((props, ref) => {
  return (
    <svg
      width="20"
      height="23"
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M10 21.08V11" stroke="#7871FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
});
